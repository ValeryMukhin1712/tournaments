#!/usr/bin/env python3
"""
Скрипт для создания базы данных tournament.db с полями start_time и end_time
"""
...
def create_tournament_database():
    """Создает базу данных tournament.db с правильной схемой"""
    ...
    try:
        ...
        print("✅ База данных tournament.db создана успешно!")
...
if __name__ == "__main__":
    print("🔄 Создаем базу данных tournament.db...")
    success = create_tournament_database()
